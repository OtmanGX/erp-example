...
export class TubeInoxComponent extends BaseConsommableComponent<Consommable> {
  filtrageArgs = ['code'];
  items: Consommable_purchases[] = [];
  addTubeToGlass(glassList) {
  ...
  constructor(MockService: TubeInoxMockService) {
    super(MockService);
    this.title = 'Tube-Inox ';
  }
}
