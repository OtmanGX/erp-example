...
import { ShortCompany } from '@tanglass-erp/core/common';

export const SHORTCOMPANY_FEATURE_KEY = 'shortCompany';

export interface State extends EntityState<ShortCompany> {
...
export const shortCompanyAdapter: EntityAdapter<ShortCompany> = createEntityAdapter<
ShortCompany
>();
